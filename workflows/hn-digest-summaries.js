export const meta = {
  ...
  phases: [{ title: 'Summarize', detail: 'one agent per story: fetch article + comments, summarize both, note fetch errors' }],
}
